 ...
 */
public class KeyEd25519Java implements KeyEd25519,Serializable{
...
//        if (NaCl.init()==1) throw new RuntimeException("NaCl load fail");
    ...
    private KeyEd25519Java(){}

    /**
     * Constructor
     *
     */
    private KeyEd25519Java(byte[] publicKey, byte[] privateKey, byte[] expandedPrivateKey, String publicKeyHex, String privateKeyHex, String expandedPrivateKeyHex) {
    ...
    public KeyEd25519 generateKeys(){
        ...
        sodium.randombytes(seed,seed.length);
    ...
    public static KeyEd25519 generateKeys(byte[] privateKey){
        ...
        KeyEd25519 key = new KeyEd25519Java(
                publicKey,
                privateKey,
                expandedPrivateKey,
...
//        int[] messageLenght = new int[]{message.length};
    ...
    public static boolean verifyMsg(byte[] signature, byte[] message, byte[] publicKey){
        return new KeyEd25519Java().verify(signature,message,publicKey);
    }
