...
import org.fermat.forum.discourse.utils.RequestParameter;
...
import static org.fermat.RequestProposalContractsNewServlet.convertInputStreamToString;
...
public class MarketCapApiClient {
    ...
    public BigDecimal getIoPPrice() throws Exception {
...
//            LOG.info("getIoPPrice URL: "+url);
            ...
            if (httpResponse.getStatusLine().getStatusCode()==200){
                ...
                throw new Exception("Something fail, server code: "+((httpResponse!=null)?httpResponse.getStatusLine().getStatusCode():"null"));
            }
            ...
            throw new Exception("Something fail, server return: "+result+", status code: "+httpResponse.getStatusLine().getStatusCode());
        }
        return iopUsdPrice;
    }
