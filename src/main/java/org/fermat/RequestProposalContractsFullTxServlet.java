...
public class RequestProposalContractsFullTxServlet extends HttpServlet {

    private static final Logger logger = Logger.getLogger(RequestProposalContractsFullTxServlet.class);


    public RequestProposalContractsFullTxServlet() {
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        logger.info("RequestProposalContractsFullTxServlet");
...
//            JSONArray transactions = jsonObject.getJSONArray("transactions");
    ...
    private String executeGetContracts(int blockHeight){
        ...
        Process p;
        try {//IoP-qt -datadir="/home/mati/IoP-data/IoP-data-1"
            p = Runtime.getRuntime().exec(new String[]{"IoP-cli","-datadir="+file.getAbsolutePath(),"getproposalcontractsFullTXO"});
            p.waitFor();
            BufferedReader reader =
                    new BufferedReader(new InputStreamReader(p.getInputStream()));
