...
package org.fermat.forum.discourse;
...
import org.fermat.forum.discourse.utils.MyWebClient;
import org.fermat.forum.discourse.utils.ResponseListener;
...
/////////////////////
	...
	public ResponseModel getUser(Map<String, String> parameters) {
		...
		methodName = webClient.enrichMethodName(methodName, this.api_key, api_username);//this.api_username);// append api_key only!
...
//			}
			...
			methodName = webClient.enrichMethodName(methodName, this.api_key, this.api_username);// append api_key only!
...
//		}
		...
		//parameters.put("filter", FILTER.NEW_TOPIC.name());
		String responseStr = webClient.get(methodName, new HashMap<String, String>());
		ResponseModel responseModel = new ResponseModel();
		responseModel.meta.code = webClient.getHttpResponseCode();
		responseModel.data = responseStr;
		/*if (responseModel.meta.code<=201) { // success
